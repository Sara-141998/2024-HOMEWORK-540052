...
public class Stanza {
	...
	private Map<Direzione, Stanza> direzione2stanzaAdiacent;
	...
	public Stanza(String nome) {
		...
		this.direzione2stanzaAdiacent = new HashMap<>();
	}
	...
	public void impostaStanzaAdiacente(Direzione string, Stanza stanza) {
		if(this.direzione2stanzaAdiacent.size() >= NUMERO_MASSIMO_DIREZIONI)
			return;
		this.direzione2stanzaAdiacent.put(string, stanza);
	}
	...
	public Stanza getStanzaAdiacente(Direzione direzione) {
		return this.direzione2stanzaAdiacent.get(direzione);
	}
	...
	public String toString() {
		...
		risultato.append("\nUscite: ");
		risultato.append(this.direzione2stanzaAdiacent.keySet().toString());
	...
	public Set<Direzione> getDirezioni() {
		return this.direzione2stanzaAdiacent.keySet();
	}
